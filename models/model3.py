...
class Generator(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        res2 = self.residual1(res1)
        res3 = self.residual1(res2)
        res4 = self.residual1(res3)
        res5 = self.residual1(res4)
        res6 = self.residual1(res5)
        res7 = self.residual1(res6)
        res8 = self.residual1(res7)
        res9 = self.residual1(res8)
