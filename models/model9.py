...
class Generator(torch.nn.Module):
    def __init__(self, input_dim, num_filter, output_dim):
        ...
        self.residual9 = BasicBlock(num_filter * 4, num_filter * 4)

        self.deconv1 = DeconvBlock(num_filter * 4, num_filter * 4, batch_norm=False)
        self.deconv2 = DeconvBlock(num_filter * 4, num_filter*2, batch_norm=False)
        self.deconv3 = DeconvBlock(num_filter*2, output_dim, kernel_size=5, stride=1,padding=2,activation=False, batch_norm=False,inst_norm=False)
    ...
    def forward(self, x):
        ...
        res9 = self.residual9(res8)
        # res7 = self.residual7(res6)
        # res8 = self.residual8(res7)
        # res9 = self.residual9(res8)


        dec1 = self.deconv1(res9)
