...
class Generator(torch.nn.Module):
    def __init__(self, input_dim, num_filter, output_dim):
        ...
        # Encoder
        self.conv1 = ConvBlock(input_dim, num_filter, kernel_size=5,stride=1,padding=2, batch_norm=False,inst_norm=False)
        ...
        self.deconv1 = DeconvBlock(num_filter * 8, num_filter * 4, batch_norm=False, dropout=True)
        self.deconv2 = DeconvBlock(num_filter * 4 * 2, num_filter*2, batch_norm=False, dropout=True)
        self.deconv3 = DeconvBlock(num_filter * 2 * 2, num_filter, batch_norm=False)
        self.deconv4 = DeconvBlock(num_filter * 2, output_dim, kernel_size=5, stride=1,padding=2,activation=False, batch_norm=False,inst_norm=False)
