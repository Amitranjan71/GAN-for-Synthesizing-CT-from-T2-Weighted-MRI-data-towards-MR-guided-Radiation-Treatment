...
class Generator(torch.nn.Module):
    def __init__(self, input_dim, num_filter, output_dim):
        ...
        # Encoder
        self.conv1 = ConvBlock(input_dim, num_filter, kernel_size=3,stride=1, batch_norm=False,inst_norm=False)
        ...
        self.deconv3 = DeconvBlock(num_filter*2, output_dim, kernel_size=3, stride=1,activation=False, batch_norm=False,inst_norm=False)
