...
class DeconvBlock(torch.nn.Module):
    def __init__(self, input_size, output_size, kernel_size=4, stride=2, padding=1, batch_norm=True, inst_norm=True,dropout=False):
...
class Generator(torch.nn.Module):
    def __init__(self, input_dim, num_filter, output_dim):
        ...
        # Encoder
        self.conv1 = ConvBlock(input_dim, num_filter, kernel_size=7,stride=1, activation=False, batch_norm=False,inst_norm=False)
        ...
        self.deconv3 = DeconvBlock(num_filter, output_dim, kernel_size=10, stride=1, batch_norm=False,inst_norm=False)
